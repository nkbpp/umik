...
public class Deloproizvodstvo {
    ...
    public Deloproizvodstvo(Long id, String reg_pref, String regnumber, String reg_postf, LocalDateTime regdate, Long id_type_send, String name, String id_com_type, String text_org) {
        this.id = id;
